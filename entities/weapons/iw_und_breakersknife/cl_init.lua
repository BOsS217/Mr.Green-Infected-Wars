...
SWEP.PrintName = "Breaker's Knife"
SWEP.DrawAmmo = false
...
SWEP.SlotPos = 0
SWEP.IconLetter = "j"
killicon.Add( "iw_und_breakersknife", "killicon/infectedwars/stalkerknife", Color(255, 0, 0, 255 ) )
...
function SWEP:DrawWeaponSelection( x, y, wide, tall, alpha )
	draw.SimpleText( "j", "CSSelectIcons", x + wide/2, y + tall*0.3, Color( 255, 0, 0, 255 ), TEXT_ALIGN_CENTER )
