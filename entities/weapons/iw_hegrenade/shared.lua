...
function SWEP:InitializeClientsideModels()
	...
	self.VElements = {
		["ammo"] = { type = "Quad", bone = "v_weapon.Flashbang_Parent", rel = "", pos = Vector(0.349, -2.212, -0.769), angle = Angle(0, 0, 180), size = 0.012, draw_func = function(wep) DrawWeaponInfo(wep) end}
	}
