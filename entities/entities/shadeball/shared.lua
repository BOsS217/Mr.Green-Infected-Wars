...
if SERVER then
	...
	function ENT:Explode()
		...
		local entlist = team.GetPlayers(TEAM_HUMAN)
		local dis
		for k, v in pairs(entlist) do
			if v:IsPlayer() and v:Team() == TEAM_HUMAN and v:GetPos():Distance(self.Entity:GetPos()) <= 150 then
