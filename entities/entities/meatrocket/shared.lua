...
if SERVER then
	...
	function ENT:Explode()
		...
		Ent:SetKeyValue("iMagnitude", math.max(8*(team.NumPlayers(TEAM_HUMAN)),60))
		Ent:SetKeyValue("iRadiusOverride", 135)
		Ent:Fire("explode", "", 0)
		
		//print("Meat rocket damage: "..math.max(8*(team.NumPlayers(TEAM_HUMAN)),60))
